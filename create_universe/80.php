...
$resxx = $stmt->execute();
$variables['update_turns_results']['result'] = \BlackNova\Services\Db::logDbErrors($pdo_db, $resxx, __LINE__, __FILE__);
...
$stmt->bindParam(':last_run', $now);
$resxx = $stmt->execute();
$variables['update_igb_results']['result'] = \BlackNova\Services\Db::logDbErrors($pdo_db, $resxx, __LINE__, __FILE__);
...
$stmt->bindParam(':last_run', $now);
$resxx = $stmt->execute();
$variables['update_planets_results']['result'] = \BlackNova\Services\Db::logDbErrors($pdo_db, $resxx, __LINE__, __FILE__);
...
$stmt->bindParam(':last_run', $now);
$resxx = $stmt->execute();
$variables['update_ports_results']['result'] = \BlackNova\Services\Db::logDbErrors($pdo_db, $resxx, __LINE__, __FILE__);
...
$stmt->bindParam(':last_run', $now);
$resxx = $stmt->execute();
$variables['update_tow_results']['result'] = \BlackNova\Services\Db::logDbErrors($pdo_db, $resxx, __LINE__, __FILE__);
...
$stmt->bindParam(':last_run', $now);
$resxx = $stmt->execute();
$variables['update_ranking_results']['result'] = \BlackNova\Services\Db::logDbErrors($pdo_db, $resxx, __LINE__, __FILE__);
...
$stmt->bindParam(':last_run', $now);
$resxx = $stmt->execute();
$variables['update_degrade_results']['result'] = \BlackNova\Services\Db::logDbErrors($pdo_db, $resxx, __LINE__, __FILE__);
...
$stmt->bindParam(':last_run', $now);
$resxx = $stmt->execute();
$variables['update_apoc_results']['result'] = \BlackNova\Services\Db::logDbErrors($pdo_db, $resxx, __LINE__, __FILE__);
...
$stmt->bindParam(':last_run', $now);
$resxx = $stmt->execute();
$variables['update_gov_results']['result'] = \BlackNova\Services\Db::logDbErrors($pdo_db, $resxx, __LINE__, __FILE__);
...
$resxx = $stmt->execute();
$variables['first_news_results']['result'] = \BlackNova\Services\Db::logDbErrors($pdo_db, $resxx, __LINE__, __FILE__);
$local_table_timer->stop();
...
$resxx = $stmt->execute();
$variables['admin_account_results']['result'] = \BlackNova\Services\Db::logDbErrors($pdo_db, $resxx, __LINE__, __FILE__);
...
for ($zz=0; $zz<$bntreg->preset_max; $zz++)
{
    ...
    $resxx = $stmt->execute();
    $variables['admin_preset_results'][$zz]['result'] = \BlackNova\Services\Db::logDbErrors($pdo_db, $resxx, __LINE__, __FILE__);
...
$resxx = $stmt->execute();
$variables['admin_zone_results']['result'] = \BlackNova\Services\Db::logDbErrors($pdo_db, $resxx, __LINE__, __FILE__);
$local_table_timer->stop();
