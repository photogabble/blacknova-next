...
{
    $update = $db->Execute("UPDATE ".\BlackNova\Services\Db::table('ships')." SET ship_colonists = 0, turns = turns - 1, turns_used = turns_used + 1 WHERE ship_id = ?;", array($playerinfo['ship_id']));
